...
/**
 * Simple unit tests that can run without Eclipse or plugin dependencies.
 * These test regex patterns and utility logic only.
 */
public class AllTests {
    ...
    private static void testCommitMessageEdgeCases() {
        ...
        java.util.regex.Pattern conventionalCommit = java.util.regex.Pattern.compile(
